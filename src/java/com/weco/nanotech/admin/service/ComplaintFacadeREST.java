 ...
 */
@Stateless
@Path("com.weco.nanotech.admin.model.complaint")
public class ComplaintFacadeREST extends AbstractFacade<Complaint> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Complaint entity) {
        super.edit(entity);
    }
    ...
    public Complaint find(@PathParam("id") BigDecimal id) {
