...
public class ConnectionController implements Serializable {
    ...
    @EJB
    private com.weco.nanotech.admin.facade.ConnectionFacade ejbFacade;
    ...
    public static class ConnectionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Connection) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Connection.class.getName());
            }
        }
